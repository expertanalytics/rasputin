...
| 14b | Delaunay insertion: Lawson flips after each refinement insertion, never across a constraint, flipped triangles rescanned; the output is constrained Delaunay and still within `--tolerance` | designed | `docs/increments/14b-delaunay-insertion.md` |
...
shipped as increment 14 (#92), and 14b is designed to fix its triangle shape.
