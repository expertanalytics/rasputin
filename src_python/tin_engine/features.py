...
three other classes -- the ``constrained``/``unconstrained`` and ``finding``
literals, and the enum-derived ``role-*`` (``svg.py:177-184``) -- which
``_edges`` then interpolates into a ``class="..."`` attribute unescaped (``svg.py:225``) --
